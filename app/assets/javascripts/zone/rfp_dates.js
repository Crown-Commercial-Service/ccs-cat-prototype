document.addEventListener('DOMContentLoaded', () => {
  ...
  if (document.getElementById('ccs_rfp_response_date_form') !== null) {

    // events and validations related to clarification date
    let clarification_expanded_div = document.getElementById('rfp_clarification_date_expanded');
    let clarification_div = document.getElementById('rfp_clarification_date');
    ...
    clarification_day.addEventListener('blur', (event) => {
      validateRfpDateDay(clarification_day, "clarification_date");
    });
    clarification_month.addEventListener('blur', (event) => {
      validateRfpDateMonth(clarification_month, "clarification_date");
    });
    clarification_year.addEventListener('blur', (event) => {
      validateRfpDateYear(clarification_year, "clarification_date")
    });
    ...
    let clarification_response_expanded_div = document.getElementById('rfp_clarification_response_date_expanded');
    let clarification_response_div = document.getElementById('rfp_clarification_response_date');
    ...
    clarification_response_day.addEventListener('blur', (event) => {
      validateRfpDateDay(clarification_response_day, "clarification_response_date");
    });
    clarification_response_month.addEventListener('blur', (event) => {
      validateRfpDateMonth(clarification_response_month, "clarification_response_date");
    });
    clarification_response_year.addEventListener('blur', (event) => {
      validateRfpDateYear(clarification_response_year, "clarification_response_date")
    });
    ...
    // 4  events and validations related to rfp response date

    let rfp_response_expanded_div = document.getElementById('rfp_response_date_expanded');
    let rfp_response_div = document.getElementById('rfp_response_date');
    rfp_response_expanded_div.classList.add('ccs-dynaform-hidden');
    ...
    document.getElementById('change_rfp_response_date').addEventListener('click', (event) => {
      event.preventDefault();
      rfp_response_expanded_div.classList.remove('ccs-dynaform-hidden');
      rfp_response_div.classList.add('ccs-dynaform-hidden');
    });

    document.getElementById('cancel_rfp_response_date').addEventListener('click', (event) => {
      event.preventDefault();
      rfp_response_expanded_div.classList.add('ccs-dynaform-hidden');
      rfp_response_div.classList.remove('ccs-dynaform-hidden');
    ...
    response_day.addEventListener('blur', (event) => {
      validateRfpDateDay(response_day, "response_date");
    });
    response_month.addEventListener('blur', (event) => {
      validateRfpDateMonth(response_month, "response_date");
    });
    response_year.addEventListener('blur', (event) => {
      validateRfpDateYear(response_year, "response_date")
    });
    ...
    let ns_expanded_div = document.getElementById('rfp_next_steps_expanded');
    let ns_div = document.getElementById('rfp_next_steps_date');
    ...
    ns_day.addEventListener('blur', (event) => {
      validateRfpDateDay(ns_day, "next_steps_date");
    });
    ns_month.addEventListener('blur', (event) => {
      validateRfpDateMonth(ns_month, "next_steps_date");
    });
    ns_year.addEventListener('blur', (event) => {
      validateRfpDateYear(ns_year, "next_steps_date")
    });
